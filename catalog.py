...
def set_meta(product_id, price=None, name=None, company=None):
    """Update (or create) a product's price/name/company."""
    with _lock:
        meta = _load()
        ...
        if company is not None:
            ...
            entry["company"] = cleaned_company.title() if cleaned_company else "Uncategorized"
