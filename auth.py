...
def init_db():
    ...
    with _lock, _connect() as conn:
        ...
        if row["c"] == 0:
            # Security: Force secure initial password via environment variable
            ...
            print("[auth] ⚠️  Save this password NOW. It will not be shown again.")
            print("[auth] Tip: Set INITIAL_ADMIN_PASSWORD env var to control this.")
            print("=" * 60)
